...
using Soenneker.Fly.Machines.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Fly.Machines.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        await _kiotaUtil.Generate(fixedFilePath, "FlyMachinesOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
